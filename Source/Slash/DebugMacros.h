...
#define DRAW_POINT(Location) if (GetWorld()) DrawDebugPoint(GetWorld(), EndLocation, 15.f, FColor::Red, true);
#define DRAW_POINT_SINGLE_FRAME(Location) if (GetWorld()) DrawDebugPoint(GetWorld(), EndLocation, 15.f, FColor::Red, false, -1.f);
